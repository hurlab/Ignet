...
$strSql="SELECT distinct geneSymbol1 FROM t_sentence_hit_gene2gene WHERE geneSymbol2='$geneSymbol1' and score>0";
if ($score != '') {
...
$strSql="SELECT distinct geneSymbol2 FROM t_sentence_hit_gene2gene WHERE geneSymbol1='$geneSymbol1' and score>0 ";
if ($score != '') {
	$strSql .= " AND score > $score";
}
if ($hasVaccine != '') {

  ...
  async function generateReport() {
    ...
    try {
      ...
      setReport({
        ...
        aiSummary: aiSummary?.summary ?? aiSummary?.data ?? null,
      })
    } catch (err) {
          ...
          <div ref={reportRef} className="bg-white border border-gray-200 rounded-lg p-6 space-y-6 text-sm">
            ...
            {report.aiSummary && (
              <div>
                ...
                <div className="mt-2 text-sm text-gray-700 leading-relaxed whitespace-pre-wrap bg-gray-50 border border-gray-200 rounded-lg p-4">
                  {report.aiSummary}
                </div>

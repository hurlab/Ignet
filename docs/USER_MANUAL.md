...
- **PubMed Literature**: 848,456 PMIDs (biomedical abstracts) analyzed for gene mentions
...
The current Ignet database (pubmed26n, updated through 2025) contains:

- **18,332 genes** with biomedical literature mentions
- **5,124,468 gene pairs** with co-occurrence evidence
- **1,898,655 sentences** containing gene interactions
...
**Navigation Bar**: Top menu bar with:
- Tool links (Dignet, Gene, GenePair, Enrichment, Compare, BioSummarAI, Analyze Text, Explore, INO, Assistant)
...
**Important Note**: The AI summary is generated from abstracts in Ignet, so it reflects what's in the literature as of the PubMed indexing date (2025 in the current database). Always verify findings in original papers.
...
- Answers are limited to genes and interactions in Ignet (PubMed through 2025)
...
Click "Generate Report" in the navigation menu (may be under "More" or similar).
...
A: The current database uses PubMed data through early 2025. Major updates occur annually. Sign up for notifications on the home page to learn about updates.
...
- Be very new (post-2025 PubMed data isn't included)
...
> "Gene interactions were identified using Ignet, an integrative gene network database constructed from 848,456 PubMed abstracts using BioBERT natural language processing [Hur et al., 2016-2026]. The database contains 5,124,468 gene-gene co-occurrences with interaction predictions and evidence sentences."
...
The database has been continuously developed and curated since 2016 and currently indexes nearly 850,000 PubMed abstracts, representing the collective biomedical knowledge of the field through the lens of gene interactions.
